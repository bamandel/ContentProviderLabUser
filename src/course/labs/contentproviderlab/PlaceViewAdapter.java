...
public class PlaceViewAdapter extends CursorAdapter {
	...
	public void add(PlaceRecord listItem) {
		...
		if (storeBitmapToFile(listItem.getFlagBitmap(), filePath)) {
			...
			ContentResolver mContent = mContext.getContentResolver();
			ArrayList<ContentProviderOperation> content = new ArrayList<ContentProviderOperation>();
			ContentProviderOperation cp = ContentProviderOperation.newInsert(PlaceBadgesContract.CONTENT_URI)
			...
			try {
				mContent.applyBatch(PlaceBadgesContract.AUTHORITY, content);
	...
	public void removeAllViews() {
		...
		ContentResolver mContent = mContext.getContentResolver();
		mContent.delete(PlaceBadgesContract.CONTENT_URI, null, null);
